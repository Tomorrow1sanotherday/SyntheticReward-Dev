...
image_dict = {}
# image_folder = "./generated_images/sd1.5_base_indomain_program"
image_folder_list = ["./generated_images/sd1.5_base_indomain_program", "./generated_images/sd1.5_a_indomain_program", "./generated_images/sd1.5_vqa_indomain_program"]


image_folder = "./generated_images/ddpo_sd1.5_base_outdomain"
...
for prompt_index, images in tqdm(image_dict.items(), desc="Processing Prompts"):
    ...
    for index, image in enumerate(images):
        result += metric.compute(image = image, prompt = prompt)
        print(f'{index}: {result}')
result = result / (len(prompt_list)*50)
print(f'{image_folder}: {result}')
