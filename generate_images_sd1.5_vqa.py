...
pipe.load_lora_weights("save_sd1.5_vqa/checkpoints/checkpoint_198", weight_name="pytorch_lora_weights.safetensors", adapter_name="vqa")
# 设置显卡为第二张显卡
...
# 保存图片的文件夹
output_dir = "generated_images/sd1.5_vqa_indomain"
