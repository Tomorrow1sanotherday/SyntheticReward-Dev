...
# from promptqa_generator import PromptQAGenerator
...
class PromptQaGenerator:
    def __init__(self, metadata_path = "./metadata", output_file="output.json"):
        self.promptQaGenerator = PromptQAGenerator(metadata_path = "./metadata", output_file="output.json")
    
    def generate_prompt_qa(self, total_scenes, scene_complexity, scene_attributes):
        self.promptQaGenerator.process(total_scenes, scene_complexity, scene_attributes)
...
if __name__ == "__main__":
    promptQaGenator = PromptQaGenerator(metadata_path = "./metadata", output_file="output.json")
    promptQaGenator.generate_prompt_qa(total_scenes = 20, scene_complexity = 6, scene_attributes = 0)
