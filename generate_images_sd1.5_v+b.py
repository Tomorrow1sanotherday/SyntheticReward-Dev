...
pipe.load_lora_weights("ddpo_sd1.5_v+b_mms_save/checkpoints/checkpoint_198", weight_name="pytorch_lora_weights.safetensors", adapter_name="v+b")
# 设置显卡为第二张显卡
...
# ]
# 保存图片的文件夹
output_dir = "generated_images/ddpo_sd1.5_v+b_mms_indomain"
