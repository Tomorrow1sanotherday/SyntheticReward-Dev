...
pipe.load_lora_weights("save_sd1.5_a/checkpoints/checkpoint_198", weight_name="pytorch_lora_weights.safetensors", adapter_name="a")
...
# 保存图片的文件夹
output_dir = "generated_images/sd1.5_a_indomain"
