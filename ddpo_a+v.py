...
def combined_scorer(vqa_pipeline, aesthetic_scorer, local_file_path="rewards.json"):
    """
    结合VQA和美学评分的评分器
    """
...
if __name__ == "__main__":
    ...
    logger = Logger(log_file="training_log2.json", image_dir="generated_images2")
    ...
    aesthetic_model = aesthetic_model.cuda()
    ...
    wandb.init(project="sd1.5_two_models_training_3", config=script_args)
    ...
    trainer = DDPOTrainer(
        training_args,
        combined_scorer(vqa_pipeline, aesthetic_model, local_file_path="rewards2.json"),
        prompt_fn,
        pipeline,
