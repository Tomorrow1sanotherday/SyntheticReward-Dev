...
pipe.load_lora_weights("ddpo_sd1.5_v+a+b_mean_save/checkpoints/checkpoint_198", weight_name="pytorch_lora_weights.safetensors", adapter_name="v+a+b")
# 设置显卡为第二张显卡
pipe.safety_checker = None
torch.cuda.set_device(0)  # 指定使用第二张显卡，通常cuda:1为第二张显卡
...
# ]
# 保存图片的文件夹
output_dir = "generated_images/ddpo_sd1.5_v+a+b_mean_indomain"
