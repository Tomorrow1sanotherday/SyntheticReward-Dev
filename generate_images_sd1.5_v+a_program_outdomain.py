...
pipe.load_lora_weights("save_sd1.5_v+a_program/checkpoints/checkpoint_198", weight_name="pytorch_lora_weights.safetensors", adapter_name="v+a")
# 设置显卡为第二张显卡
...
# 保存图片的文件夹
output_dir = "generated_images/sd1.5_v+a_outdomain_program"
