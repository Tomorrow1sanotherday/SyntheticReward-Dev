...
def combined_scorer(vqa_pipeline, aesthetic_scorer, local_file_path="rewards_sd1.5_v+a.json"):
    """
    结合VQA和美学评分的评分器
    """
...
if __name__ == "__main__":
    ...
    logger = Logger(log_file="training_log_v+a.json", image_dir="train_generated_images/sd1.5_v+a")
    ...
    training_args.project_kwargs = {
        ...
        "total_limit": 5,
        "project_dir": "./save_sd1.5_v+a",
    }

    training_args.log_with = "wandb"
    wandb.init(project="sd1.5_v+a", config=script_args)
    ...
    checkpoint_dir = './save_sd1.5_v+a/checkpoints/'
